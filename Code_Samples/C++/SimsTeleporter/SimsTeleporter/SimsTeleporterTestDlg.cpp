// SimsTeleporterTestDlg.cpp : implementation file
//

#include "stdafx.h"
#include "SimsTeleporterTest.h"
#include "SimsTeleporterTestDlg.h"
...
/////////////////////////////////////////////////////////////////////////////
// CSimsTeleporterTestDlg dialog

CSimsTeleporterTestDlg::CSimsTeleporterTestDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CSimsTeleporterTestDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CSimsTeleporterTestDlg)
...
void CSimsTeleporterTestDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CSimsTeleporterTestDlg)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CSimsTeleporterTestDlg, CDialog)
	//{{AFX_MSG_MAP(CSimsTeleporterTestDlg)
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
/////////////////////////////////////////////////////////////////////////////
// CSimsTeleporterTestDlg message handlers

BOOL CSimsTeleporterTestDlg::OnInitDialog()
{
	...
	
	{
		...
		{
			string tests = SimsTeleporter::Test( s_testNetwork, s_serverName, inst );
...
void CSimsTeleporterTestDlg::OnPaint() 
{
	if (IsIconic())
	{
...
HCURSOR CSimsTeleporterTestDlg::OnQueryDragIcon()
{
